        ...
        private static void ApplyLocalProperties(XmlElement xamlElement, Hashtable localProperties, bool isBlock)
        {
            ...
            while (propertyEnumerator.MoveNext())
            {
                switch ((string)propertyEnumerator.Key)
                {
                    ...
                    case "margin-top":
                        marginSet = true;
                        marginTop = ((string)propertyEnumerator.Value).Replace("px","").Replace("em","");
                        break;
                    case "margin-right":
                        marginSet = true;
                        marginRight = ((string)propertyEnumerator.Value).Replace("px","").Replace("em","");;
                        break;
                    case "margin-bottom":
                        marginSet = true;
                        marginBottom = ((string)propertyEnumerator.Value).Replace("px","").Replace("em","");;
                        break;
                    case "margin-left":
                        marginSet = true;
                        marginLeft = ((string)propertyEnumerator.Value).Replace("px","").Replace("em","");;
                        break;
